		...
		<div class="layui-body">
		    ...
		    <div style="padding: 15px;">
		        <fieldset class="layui-elem-field layui-field-title animated slideInDown" style="margin-top: 20px;">
		            <legend>所有部門分類</legend>
		        </fieldset>
		        <div class="ui cards animated fadeInUp">
		            <c:forEach var="stock" items="${stocks}">
		                <div class="card">
		                    <div class="content">
		                        <div class="header">${stock.stockSection}</div>
		                        <div class="description">
		                            商品分類${stock.stockSection}
		                        </div>
		                    </div>
		                        <a class="ui bottom attached button" 
		                        href="${pageContext.request.contextPath}/section/${stock.stockSection}">
		                        查看
		                        </a>
